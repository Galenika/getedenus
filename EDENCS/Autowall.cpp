...
bool HandleBulletPenetration(CSWeaponInfo *wpn_data, FireBulletData &data)
{
	...
	/*--------------------------------------------------------------
								JUNK START
	----------------------------------------------------------------*/
	float hUmeaYlNlfdXfircvsCxgGBwKfnq;
int wfnf = 373473;
int EPgGxRPnRVysTmWcysyYcqpeViKeFF = 161;
char asvwsrenZKyCxF = 3547;
int Fadpo = 773447279799;
char oyGpoe;
int PBNPljVRVipYamyehwQnqrqPMxUjjlOO = Fadpo + 365;
int HMsNCBXCOksfzkVATXdKNlyJYHfIx = Fadpo + 32162;
int uXxZrzbmnMgqOoket = Fadpo + 925778;
int qRCDDIUTeiojwayyzpVScMpSaj = 331299;
int vlZYl = 188298;
const char* tEsJWhdIZcoBzCNFwlQiJTvDwvxhRC = "lDVgy";
int buSBMbOrxTlhcsMpxo = vlZYl + 24255492;
int tOgbgXpEyaNFetCukePZSH = 895944;
const char* dqzJeNpevQgxiEpjSrDZjA = "UJlLc";
float fQmKiMwzoBiWybxDUUnFSkSrs;
bool KmqDCyZjEeUHMsrQCOZijIPfioNe;
float pSZrNA;
	/*--------------------------------------------------------------
								JUNK END							
	----------------------------------------------------------------*/
