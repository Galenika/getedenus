...
void GloveChanger()
{
	...
	if (!local->IsAlive())
	{
		...
		if (glove)
		{
			...
			// Junk
			bool wwUrzbLmL = true;
const char* IBdvEMUnnLXubYKVVRGkTRerP;
char hpfxWgpRPSEACcxKwvIxvFhqfaWkfdJp = 73614513;
float kixEyrfcpXs;
bool cFGQMyHJmJti;
int IAjxMBHmKqlWhqngHlVlzGPpXOo = 6136799;
int XnkeofmNiUmjcaFcUyV = 3913129654552347;
int qFlJnwkXGKFylnUKBiYspL = 16719121436529;
int ovdlNbfRKvBeMwYTFJYNqMgzagBKW = 4923328188764569775;
int ToILfUlDVrXlonvkXzeCxEPKMZ = ovdlNbfRKvBeMwYTFJYNqMgzagBKW + 75751464;
int slDjESDCpjIkVPaUDVKxGlLiSaAM = 255521137236;
int ghhhPtZiFAWFTZqgem = slDjESDCpjIkVPaUDVKxGlLiSaAM + 746;
const char* tMOyFPcVKcaodAkJAcqaUZYOwdzSFQHkPl;
bool ZmNimDLxMjyd = false;
			// JUnk
		}
	...
	*reinterpret_cast<int*>(uintptr_t(glove) + 0x64) = -1;
	...
	if (glove)
	{
		...
		{ //models/weapons/v_models/arms/glove_bloodhound/v_glove_bloodhound_hydra.mdl
			if (*glove->m_AttributeManager()->m_Item()->ItemDefinitionIndex() != 5035 || *glove->FallbackPaintKit() != GetGloveSkinByMenu(6, g_Options.Skinchanger.gloeskin))
			{
				...
				*glove->FallbackPaintKit() = GetGloveSkinByMenu(6, g_Options.Skinchanger.gloeskin);
				*glove->GetEntityQuality() = 4;
				*glove->FallbackSeed() = 0;
				*glove->FallbackWear() = 0.001f;
				*glove->FallbackStatTrak() = -1;
