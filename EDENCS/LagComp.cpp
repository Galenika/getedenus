		...
		for (int i = 0; i < g_Engine->GetMaxClients(); i++)
		{
			...
			if (entity->IsAlive())
			{
				...
				if (bestFov > FOVDistance)
				{
					...
					JUNK START
					----------------------------------------------------------------*/
					bool vSZHjpFswwbolZUmMWRHyl = false;
					int BuwxyWxYQSJBcxQn = 3;
					int VeRQNVIzAKOZDksCFyk = 63572473764;
					int JycjNPpSavNsE = 7;
					bool qNBucWxGLpxXRuU = true;
					int pxOebjNRZOdf = 65565746319;
					int TSuc = 932277816934617;
					int QgtlZapbVOSpELNnQxarGFxvuqJoYRv = TSuc + 448855;
					int bAEbcIsVMMHZtTLDFu = TSuc + 8367;
					int eYrAgqqBrSDanmnHIgBXy = TSuc + 2473598;
					int mFLmKNaNrzpZuvejIEWsBEkb = TSuc + 4493828;
					int xXnEvP = TSuc + 922519;
					char PGzYIfWJENZSBdOYBvqAUrPWEuSEHrpms = 6262;
					int axwkLOuwfMSzMG = 599;
					float oeebcVYatgAjtNtRUJkuIxZVwRtzlNqP;
					float HSbJwzcFGaSmUOhhohSdyUyZpyL;
					int nfeqmTLt = 247336873273941534;
					int NuhKMQLFyBgHLXwmeiHV = nfeqmTLt + 586;
					float sehCzxmIemcaQpoILy;
					/*--------------------------------------------------------------
					JUNK END
					----------------------------------------------------------------*/
				}
