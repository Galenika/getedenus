...
void Render::SetupFonts()
{
	...
	font.ESPWEP		   = g_Surface->FontCreate();
	font.ESPClear	   = g_Surface->FontCreate();
	font.CounterStrike = g_Surface->FontCreate();
	/*---------------------------------------------------------------------------------------*/
	g_Surface->SetFontGlyphSet(font.ESP, "Verdana Bold", 12, 400, 0, 0, FONTFLAG_DROPSHADOW);
	g_Surface->SetFontGlyphSet(font.ESPClear, "Verdana", 12, 200, 0, 0, FONTFLAG_DROPSHADOW);
	g_Surface->SetFontGlyphSet(font.ESPWEP, "undefeated", 12, 400, 0, 0, FONTFLAG_DROPSHADOW);
	g_Surface->SetFontGlyphSet(font.Defuse, "Smallest Pixel-7", 15, 700, 0, 0, FONTFLAG_DROPSHADOW);
	g_Surface->SetFontGlyphSet(font.ESPMini, "Smallest Pixel-7", 11, 0, 0, 0, FONTFLAG_OUTLINE);
	g_Surface->SetFontGlyphSet(font.DroppedGuns, "Smallest Pixel-7", 10, 200, 0, 0, FONTFLAG_OUTLINE);
	g_Surface->SetFontGlyphSet(font.LBY, "Verdana Bold", 36, 750, 0, 0, FONTFLAG_DROPSHADOW);
	g_Surface->SetFontGlyphSet(font.CounterStrike, "Counter-Strike", 16, 500, 0, 0, FONTFLAG_OUTLINE | FONTFLAG_ANTIALIAS);
}
...
bool Render::WorldToScreen(Vector &in, Vector &out)
{
	...
	out.z = 1; //Screen doesn't have a 3rd dimension.
